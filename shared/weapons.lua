...
QBShared.Weapons = {
    ...
    [`weapon_tacticalrifle`] 		 = {['name'] = 'weapon_tacticalrifle', 	 	['label'] = 'Tactical Rifle', 				['weapontype'] = 'Assault Rifle',	['ammotype'] = 'AMMO_RIFLE',	['damagereason'] = 'Ended / Rifled / Shot down / Floored'},
